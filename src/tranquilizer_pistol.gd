extends Node3D
class_name TranquilizerPistolTool

const PROFILE_ID := "tranquilizer_pistol"
const BULLET_SCENE := preload("res://character/weapons/TranquilizerBullet.tscn")
...
func _get_center_screen_direction(shooter: CollisionObject3D) -> Vector3:
	...
	var aim_point := ray_origin + ray_direction * CombatBalance.get_float(PROFILE_ID, "range")
