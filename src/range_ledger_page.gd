...
const PRODUCTS := {
	"mpx": {
		...
		"category": "紧凑型冲锋枪",
		"range": "100 米",
		"summary": "适合近中距离快速反应，体积紧凑，便于在仓库和狭窄道路中携带。",
	},
	"m4": {
		"name": "M4 卡宾枪",
		"category": "现代卡宾枪",
		"range": "中远距离",
		"summary": "射击表现均衡，适合需要在不同环境中保持稳定火力的队伍。",
	},
	"ar15": {
		"name": "AR15 步枪",
		"category": "现代步枪",
		"range": "较远距离",
		"summary": "更偏向远距离使用的步枪，适合开阔地形和需要保持距离的场合。",
	},
	"shotgun": {
		"name": "双管猎枪",
		"category": "双管猎枪",
		"range": "近距离",
		"summary": "近距离瞬间压制力强，适合室内、车辆周围和短距离防卫。",
	},
	"hunting_rifle": {
		"name": "栓动猎枪",
		"category": "栓动步枪",
	...
	"crossbow": {
		...
		"category": "弩具",
		"range": "120 米",
		"summary": "适合安静处理远处目标；使用前应确认箭矢准备和周围安全。",
	},
	"suppressed_pistol": {
		"name": "消音手枪",
		"category": "单手手枪",
		"range": "100 米",
		"summary": "便于随身携带和快速拔取，适合需要降低声响的短时行动。",
	},
	"future_m4": {
		"name": "FutureM4",
		"category": "未来型卡宾枪",
...
const PAGE_DEFINITIONS := {
	PAGE_CATALOG: {
		...
		"products": ["mpx", "m4", "ar15", "shotgun", "hunting_rifle", "crossbow", "suppressed_pistol"],
	},
	PAGE_FUTURE_SERIES: {
		"title": "Future 系列调查档案",
