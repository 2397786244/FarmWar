...
DEFAULT_OUTPUT = os.path.join(SCRIPT_DIR, "generated_farmwar_enemies")
FPS = 30
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate rigged FarmWar enemy villain characters with animations, GLB export, and pose checks."
    )
