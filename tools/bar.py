...
#
# Generates one GLB:
#   FTF_Bar_Pentagonal_RedBrick_Enterable_v2.glb
#
...
#
# OUTPUT
#   generated_farmtown_buildings/FTF_Bar_Pentagonal_RedBrick_Enterable_v2.glb
#
# Run:
#   blender --background --factory-startup --python generate_farmtown_bar_pentagonal_v2.py
# ---------------------------------------------------------------------
...
OUTPUT_FILE = "FTF_Bar_Pentagonal_RedBrick_Enterable_v2.glb"

ROOT_NAME = "FTF_Bar_Pentagonal_RedBrick_Enterable_v2"
