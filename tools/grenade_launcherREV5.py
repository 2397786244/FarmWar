...
#
# Generates:
#   generated_farmtown_tools/FTF_Tool_GrenadeLauncher_Olive_v4.glb
#
# DESIGN
...
#   clean top rail, enlarged revolving drum and chunky game-readable silhouette.
# - Low-poly / stylized game asset intended for Godot.
# - Handheld, shoulder-fired, chunky proportions, easy-to-read silhouette.
#
# EXPORTED HIERARCHY
#   FTF_Tool_GrenadeLauncher_Olive_v4
#   |-- FTF_Tool_GrenadeLauncher_Olive_v4_Static
...
OUTPUT_FILE = "FTF_Tool_GrenadeLauncher_Olive_v4.glb"
SCRIPT_REVISION = "REV5_GRENADE_STYLE_CLEAN"

ROOT_NAME = "FTF_Tool_GrenadeLauncher_Olive_v4"
...
def build_grenade_launcher():
    ...
    # Chunky side hinge blocks make the silhouette read more clearly as a
    # revolving grenade launcher and avoid tiny fragment-like detailing.
    add_cube(
        "Drum_LeftHingeBlock",
        (-0.34, -0.32, 0.47),
        (0.09, 0.24, 0.16),
    ...
    # Drum side detailing is intentionally kept clean in REV4 to avoid
    # small metallic protrusions that can read as clipping fragments.
    ...
    for index, y in enumerate((-0.26, -0.08, 0.10)):
        add_cube(
    ...
    # No mechanical sights are placed on top of the rail in REV4.
    # The user requested a clean top rail without additional sight geometry.
    ...
    # Side latches are kept dark and embedded slightly into the receiver skin
    # so they do not read as bright metallic fragments.
    add_cube(
        "Detail_LeftLatch",
        (-0.275, -0.02, 0.49),
        (0.07, 0.20, 0.12),
...
def validate_attachment_pairs():
    pairs = [
        ...
        ("Drum_LeftHingeBlock", "Receiver_OliveMain", 0.005),
        ("Drum_RightHingeBlock", "Receiver_OliveMain", 0.005),
        ...
        ("TopRail_Tooth_02", "TopRail_OliveBase", 0.005),
