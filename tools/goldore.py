...
ASSET_NAME = "FTF_Resource_GoldOre_1m"
...
def build_asset():
    ...
    rock = make_material("GoldOreRock", "#4D5552", roughness=0.88, metallic=0.0)
    ore_main = make_material("GoldOreVein", "#E9B93F", roughness=0.48, metallic=0.32)
    ore_highlight = make_material("GoldOreHighlight", "#F3D36A", roughness=0.42, metallic=0.28)
