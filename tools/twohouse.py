...
#
# Run:
#   blender --background --factory-startup --python generate_farmtown_two_story_house_ramp_v4.py
# ---------------------------------------------------------------------
...
OUTPUT_FILE = "FTF_House_NorthAmerican_TwoStory_Ramp_v4.glb"

ROOT_NAME = "FTF_House_NorthAmerican_TwoStory_Ramp_v4"
...
def build_house():
    ...
    rail_z = FOUNDATION_H + FIRST_WALL_H + 0.62
    rail_post_h = 1.05
