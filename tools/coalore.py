...
def build_asset():
    ...
    rock = make_material("CoalOreRock", "#76513B", roughness=0.94, metallic=0.0)
    ore_main = make_material("CoalVein", "#2C343A", roughness=0.76, metallic=0.05)
    ore_highlight = make_material("CoalHighlight", "#4F5B61", roughness=0.70, metallic=0.08)
